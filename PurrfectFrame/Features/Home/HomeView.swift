...
struct HomeView: View {
    ...
    private var featureRow: some View {
        HStack(alignment: .top, spacing: 8) {
            ...
            FeaturePill(icon: "calendar", title: "Daily challenge", subtitle: "new moment every day", tint: Palette.moss)
            FeaturePill(icon: "cat.fill", title: "Cute chaos", subtitle: "they do their own thing", tint: Palette.sky)
        }
        .padding(.top, 8)
    }
